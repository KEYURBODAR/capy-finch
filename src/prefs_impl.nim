...
genPrefs:
  Display:
    ...
    hideMediaRail(checkbox, false):
      "Hide profile media rail"
    ...
    excludeRepliesByDefault(checkbox, false):
      "Exclude replies from search, Following, and Lists by default"

    hideCommunityNotes(checkbox, false):
      "Hide community notes"

    hideLinkCards(checkbox, false):
      "Hide link cards"

    hideInlineArticles(checkbox, false):
      "Hide inline article panels on post pages"

    showProfileBio(checkbox, true):
      "Show profile bio in the sidebar card"
  ...
  Media:
    ...
    hideMediaPreviews(checkbox, false):
      "Hide photo/video/gif previews"

  Performance:
    preloadMedia(checkbox, true):
      "Preload banner and media images"

    routePrefetch(checkbox, true):
      "Prefetch likely next pages on hover/touch"
